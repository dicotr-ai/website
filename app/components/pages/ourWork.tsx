            ...
            <section className="bg-gray-50 py-20">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-8">
                        <ServiceItem image='./star-circle-and-arrow.svg' title={<>Content, Strategy & <br />Planning</>} />
                        <ServiceItem image='./white-board.svg' title={
                            <>
                                Copywriting & Creative <br />Content
                            </>
                        } />
                        <ServiceItem image='./increasing-bargraph.svg' title={
                            <>
                                SEO & Content <br />Optimization
                            </>
                        } />
                        <ServiceItem image='./content-calenders-and-compaigns.svg' title={
                            <>
                                Content Calendars <br />& Compaigns
                            </>
                        } />
                        <ServiceItem image='./person-with-magnifient.svg' title={
                            <>
                                Social Media <br />Amplification
                            </>
                        } />
                        <ServiceItem image='./audit-diary.svg' title={
                            <>
                                Website Audits & <br />Experience Reviews
                            </>
                        } />
                    </div>
                </div>
