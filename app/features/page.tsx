...
const Button = ({
  ...
  const secondaryClasses =
    'bg-white text-green-500 border border-green-500 hover:bg-gray-100';
    ...
    <div className="container mx-auto text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        ...
        <div className="flex flex-col items-center">
          ...
          <h4 className="font-semibold text-gray-800 mb-2">
            <span>Optimise for better</span> <br />
  ...
  <section className="bg-gray-800 text-white py-20 px-6">
    <div className="container mx-auto text-center">
      ...
      <p className="max-w-xl mx-auto mb-8">
        Whether you&apos;re launching or scaling, we&apos;re ready to support your journey with a full-stack digital marketing framework.
      </p>
